...
def populate_age_data(gender, sex, ages, temp_data, range_data, year_ranges, place):
    for age in ages:
        ...
        for i in year_ranges:
            ...
            range_data.loc[
                (range_data.Year == i) &
                (range_data.Local_Auth_District == place),
                var_name] = vals
"""
Part 1
...
def part_one():
    ...
    for place in places:
        ...
        # 1 = male, 2 = female
        populate_age_data('Male', 1, age_ranges, temp_data, range_data, year_ranges, place)
        populate_age_data('Female', 2, age_ranges, temp_data, range_data, year_ranges, place)
